...
import { State, Title, Property, IssueLabel, TwoProperties } from '../common'
...
const IssueItem: FC<{
  ...
  useInitialisedDeskproAppClient((client) => {
    getEntityAssociationCountService(client, `${project_id}:${iid}`).then(
      setTicketCount
    )
  })
  ...
  return (
    <>
      ...
      <Property label="Asignees" text={<Assignees assignees={assignees} />} />
      <Property
        label="Labels"
        text={
          <Stack wrap="wrap" gap={6}>
      ...
      />
      <Property label="Deskpro Tickets" text={ticketCount} />
    </>
  )
}
